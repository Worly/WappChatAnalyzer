...
namespace WappChatAnalyzer.Migrations
{
    ...
    [Migration("20220225223622_FixNormalizedSentDate")]
    partial class FixNormalizedSentDate
    {
            ...
            modelBuilder.Entity("WappChatAnalyzer.Domain.Message", b =>
                {
                    ...
                    b.Property<DateOnly>("NormalizedSentDate")
                        ...
                        .HasColumnType("date")
                        .HasComputedColumnSql("CASE WHEN EXTRACT(hour FROM SentTime) < 7 THEN DATE_ADD(SentDate, INTERVAL -1 day) ELSE SentDate", true);
